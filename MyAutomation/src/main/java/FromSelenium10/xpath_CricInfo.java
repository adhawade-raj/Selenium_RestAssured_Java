...
public class xpath_CricInfo {
	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//		xpath_CricInfo.SelectPlayer(driver, "Sarfaraz Khan","David Warner");
		xpath_CricInfo.SelectPlayer(driver, "David Warner");
...
//		/span[contains(class, 'ds-inline)]//following::span[contains(class, 'ds-text-tight-s')]//following :: td[(@class='ds-min-w-max ds-text-right ds-hidden')]
		...
		{
		List<WebElement> Test = (driver.findElements(By.xpath("//a[contains(@title,'"+Player+"')]//parent::span//following::td[1]")));
		System.out.println(Test.size());

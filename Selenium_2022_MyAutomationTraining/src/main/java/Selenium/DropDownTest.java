...
public class DropDownTest {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> monthlist = DropDownUtilJava.getdropDownValues(month);
		System.out.println(monthlist);
		
		ArrayList<String> daylist = DropDownUtilJava.getdropDownValues(day);
		System.out.println(monthlist);
		
		ArrayList<String> yearlist = DropDownUtilJava.getdropDownValues(year);
		System.out.println(monthlist);
